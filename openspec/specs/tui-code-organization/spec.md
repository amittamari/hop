# Capability: TUI Code Organization

## Purpose

Keeps the TUI source tree navigable by holding modules under a soft size limit
and splitting oversized files along responsibility boundaries, without changing
