# Capability: Mouse Scroll

## Purpose

Defines how the TUI captures mouse/trackpad wheel events and routes them to the
conversation preview pane, including capture lifecycle, scroll targeting,
granularity, and the no-op behavior when the preview is hidden.
