...
- *(deps)* bump toml from 1.1.2+spec-1.1.0 to 1.1.3+spec-1.1.0 ([#79](https://github.com/amittamari/hop/pull/79))
- *(deps)* bump clap from 4.6.1 to 4.6.2 ([#80](https://github.com/amittamari/hop/pull/80))
